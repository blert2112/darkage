...
--			local t0 = os.clock()
			...
			or generate_stratus(c_chalk, {c_stone}, {c_stone,c_air}, vm_data, vm_area, minp, maxp, seed+3, 4, 25, 8, 0, -20,  50)
			or generate_stratus(c_ors, {c_stone}, {c_stone,c_air,c_water}, vm_data, vm_area, minp, maxp, seed+4, 4, 25, 7, 50, -200,  500)
			or generate_stratus(c_shale, {c_stone}, {c_stone,c_air}, vm_data, vm_area, minp, maxp, seed+5, 4, 23, 7, 50, -50,  20)
			or generate_stratus(c_slate, {c_stone}, {c_stone,c_air}, vm_data, vm_area, minp, maxp,	seed+6, 6, 23, 5, 50, -500, 0)
			or generate_stratus(c_schist, {c_stone}, {c_stone,c_air}, vm_data, vm_area, minp, maxp, seed+7, 6, 19, 6, 50, -31000, -10)
			or generate_stratus(c_basalt, {c_stone}, {c_stone,c_air}, vm_data, vm_area, minp, maxp, seed+8, 5, 20, 5, 20, -31000, -50)
			or generate_stratus(c_marble, {c_stone}, {c_stone,c_air}, vm_data, vm_area, minp, maxp, seed+9, 4, 25, 6, 50, -31000,  -75)
			or generate_stratus(c_serpentine, {c_stone}, {c_stone,c_air}, vm_data, vm_area, minp, maxp, seed+10, 4, 28, 8, 50, -31000,  -350)
			or generate_stratus(c_gniess, {c_stone}, {c_stone,c_air}, vm_data, vm_area, minp, maxp, seed+11, 4, 15, 5, 50, -31000, -250)
